...
import VertvoltComponent from './direflow-components/vertvolt-component';

VertvoltComponent.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('vertvolt-component is mounted on the DOM', element);
});
